  ...
  useEffect(() => {
    const fetchAppointments = async () => {
      try {
        ...
        setDoctorCount(doctorsRes.data.doctors?.length ?? 0);
      } catch (error) {
        setAppointments([]);
        setDoctorCount(0);
      }
        ...
        <div className="banner">
          <div className="firstBox">
            ...
            <div className="content">
              ...
              <p>
                The Admin in a Hospital Management System plays a central role
                in managing and controlling all hospital operations.
              </p>
            </div>
          </div>
